...
\begin{document}
\title{Background Report: \\Gradual Typing for Octave Language}
...
owner/author(s).}
\titlenote{Revised on November 23, 2018.}
...
\input{project-background-report-body}

\bibliographystyle{ACM-Reference-Format}
\bibliography{project-background-report-bibliography}
