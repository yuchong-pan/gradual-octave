...
We will be using the resources listed in Section \ref{sec-supporting-documents}
...
project, listed in Section \ref{sec-supporting-documents}. For the language choice,
