...
\subsection{Parsing}
For parsing, we have updated the BNF of the proposed type annotations to handle the new syntax and have introduced a new matrixT AST type that can be parameterized with shape and type information. The updated BNF can be found at \cite{yuchong2018gradual}.
